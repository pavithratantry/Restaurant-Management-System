<section id="southindian" class="container-fluid">
              ...
              <div class="col-sm-6 col-md-3 col-xl-3">
                <div class="card h-100">
                  ...
                  <form method="POST" action="cart.php">
                    <img class="card-img-top" src=<?php echo $data['item_image'] ?> alt="dosa">
      ...
      <div class="carousel-item">
        <div class="container">
          <div class="row">
            ...
            $sql = "SELECT * FROM `item` WHERE `category_id` = 2 AND `item_id` > 12 ";
            $result = mysqli_query($conn, $sql);
            //print_r($data);
            while ($data = mysqli_fetch_assoc($result)) {
            ?>
              <div class="col-sm-6 col-md-3 col-xl-3">
                <div class="card h-100">
                  ...
                  <form method="POST" action="cart.php">
                    <img class="card-img-top" src=<?php echo $data['item_image'] ?> alt="upma">
